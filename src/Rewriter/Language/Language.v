    ...
    Class ExprExtraInfoT {exprInfo : ExprInfoT} :=
      {
        ...
        try_make_transport_cps :> type.try_make_transport_cpsT (base.type base)
        := _;
        ...
        default :> @DefaultValue.type.base.DefaultT (base.type base) (base.interp base_interp)
        := _;
        defaultExpr :> forall var, @DefaultValue.type.base.DefaultT (type.type (base.type base)) (@expr.expr (base.type base) ident var)
        := _;
        reflect_base_beq :> reflect_rel (@eq base) base_beq;
