  ...
  Definition args_of_size' (test_tac_n : nat) (s : size)
    := let ls
           := match test_tac_n, s with
              ...
              | 2, Fast => [(10, 2); (9, 3); (8, 5); (7, 9); (6, 15); (5, 30); (4, 40); (3, 90); (2, 150); (1, 350)]
              | 3, Fast => [(10, 1); (9, 3); (8, 7); (7, 15); (6, 25); (5, 50); (4, 80); (3, 150); (2, 250); (1, 500)]
              | 4, Fast => [(9, 1); (8, 2); (7, 3); (6, 5); (5, 11); (4, 30); (3, 50); (2, 100); (1, 250)]
              | 0, Medium => [(16, 3); (12, 100)]
              | 1, Medium => [(15, 3)]
              | 2, Medium => [(10, 3); (11, 2)]
              | 3, Medium => [(10, 3); (11, 2)]
              | 4, Medium => [(8, 3); (9, 2); (10, 1)]
              | 0, Slow => [(16, 4)] (* ??? *)
              | 1, Slow => [(16, 4)] (* ??? *)
