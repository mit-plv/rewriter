Rewriter
=====
[![CI (Coq, opam)](https://github.com/mit-plv/rewriter/actions/workflows/coq-opam-package.yml/badge.svg?branch=master)](https://github.com/mit-plv/rewriter/actions/workflows/coq-opam-package.yml?query=branch%3Amaster)
